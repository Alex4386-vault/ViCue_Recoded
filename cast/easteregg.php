...
<body style="background-color:#242424 !important; color:#FFF; font-family: 'Noto Sans KR', sans-serif;">
	...
	<?php
        ...
        $log = ("<span style=\"color:#2980b9\"><strong>[BROADCAST]</strong>방송실 구역에서 이스터 에그가 구동되었습니다. </span> <span style=\"font-size:8px\">" + date("Y-m-d") + " " + date("h:i:sa") + " at IP" + $ip_address + "</span> <br> \n");
