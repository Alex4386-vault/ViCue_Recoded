...
$new_notice = str_ireplace("</object>","</preventxss_object>",$new_notice);
	...
	$new_notice = str_ireplace("<svg","</preventxss_svg",$new_notice);
        ...
        $log = ("<span style=\"color:#2980b9\"><strong>[ADMIN]</strong></span> 현재 공지사항이 <strong>" + $new_notice + "</strong>로 변경되었습니다. <span style=\"font-size:8px\">" + date("Y-m-d") + " " + date("h:i:sa") + " at IP" + $ip_address + "</span> <br> \n");
