...
<body style="background-color:#242424 !important; color:#FFF">
	...
	<?php
        ...
        $log = ("<span style=\"color:#2980b9\"><strong>[PREPARATION]</strong></span> <strong><span style=\"color:#e74c3c\">비상! </span>준비실 구역</strong>에서&nbsp;<br />비상사태가 발생했습니다! <span style=\"font-size:8px\">" + date("Y-m-d") + " " + date("h:i:sa") + " at IP" + $ip_address + "</span> <br> \n");
